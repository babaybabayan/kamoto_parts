...
class BarangController extends Controller{
    public function index(){
        $brg = DB::table('product_name as a')->select('a.id','a.code_product','a.name','a.id as idb','b.name as nameu','b.id as idu')->join('unit as b', 'a.id_unit', '=', 'b.id')->orderBy('a.name','asc')->get();
        $unit = Unit::all();
