<html>
  <head>
    <style>
      ...
      #content .page:after { content: counter( page, upper); }
    </style>
  </head>
  <body>
  <script type="text/php">
    ...
    <div id="footer" style="left: 30px; bottom: 0px; right: 30px; height: 130px;">
      <div>
        <div style="border-top: 1px solid #000000; width: 100%">
          ...
          <div style="float: right; width: 25%">
            <table style="width: 100%">
              <tr>
                <td style="width: 50%"><font size="11pt"><b>Sub Total</b></font></td>
                <td style="width: 50%; text-align: right"><font size="11pt">{{ $kontol }}</font></td>
              </tr>
              <tr>
                <td><font size="11pt"><b>Discount</b></font></td>
                <td style="text-align: right"><font size="11pt">-</font></td>
              </tr>
              <tr>
        ...
        <div style="width: 100%; text-align: center">
          ...
          <div style="float: right; width: 50%">
            <div style="float: left; border: 1px solid #000000; width: 40%; margin-top: 7px">
              <font size="11pt">No. Rekening BCA</font>
              <br>
              <font size="11pt"><b>A/C. 379.011.0969</b></font>
              <br>
              <font size="11pt">A.N YUFIRA</font>
            </div>
    ...
    <div id="content" style="margin-top: 0px ;margin-bottom: 120px; margin-left: 30px; margin-right: 30px">
      <table style="width: 100%;" id="tbinvpnj">
        <thead>
          <tr>
            ...
            <th style="width: 43%; text-align: left;"><font size="11pt"><b>Nama Barang</b></font></th>
            ...
            <th style="width: 8%; text-align: right;"><font size="11pt"><b>Disc%</b></font></th>
        ...
        <?php
          for ($i; $i < 50; $i++) { ?> 
            ...
            <tbody>
              <tr>
                <td style="text-align: right;"><font size="11pt"><input type="text" class="page" value="{{$i}}">{{$i}}</font></td>
                <td><font size="11pt">ASJ003</font></td>
                <td><font size="11pt">AS JEDEK ROBAHAN ASSY JUP Z</font></td>
                <td style="text-align: right;"><font size="11pt">1</font></td>
                <td><font size="11pt">UNIT</font></td>
                <td style="text-align: right"><font size="11pt">{{rupiah(10000)}}</font></td>
                <td style="text-align: right"><font size="11pt">5</font></td>
                <td style="text-align: right"><font size="11pt">{{$i}}</font></td>
              </tr>  
            </tbody>
            <?php
            $kontol += $i; 
