...
Route::group(['middleware'=> 'auth'], function () {
    ...
    Route::get('/saldo-stock', [BarangController::class, 'saldo']);
    Route::get('/persediaan', [BarangController::class, 'persediaan']);
    Route::get('/product/get-search-product', [BarangController::class, 'getProductWithPrice']);
    Route::get('/product/get-product/{id_brg}', [BarangController::class, 'getProductById'])->name('product.update');
});
